...
\author{\spacedlowsmallcaps{Michal Pavelka*\textsuperscript{1} \& Ilya Peshkov\textsuperscript{2} }} % The article author(s) - author affiliations need to be specified in the AUTHOR AFFILIATIONS block
...
\let\thefootnote\relax\footnotetext{\textsuperscript{1} \textit{Mathematical Institute, Faculty of Mathematics and Physics, Charles University, Sokolovská 83, 186 75 Prague, Czech Republic, \href{mailto:pavelka@karlin.mff.cuni.cz}{e-mail}}}
\let\thefootnote\relax\footnotetext{\textsuperscript{1} \textit{Institut de Math\'{e}matiques de Toulouse, Universit\'{e} Toulouse III, F-31062 
	Toulouse, France, \href{mailto:peshkov@math.nsc.ru}{e-mail}}}
